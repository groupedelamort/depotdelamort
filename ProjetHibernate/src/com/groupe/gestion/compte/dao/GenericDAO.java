package com.groupe.gestion.compte.dao;
...
import com.groupe.gestion.compte.util.HibernateUtil;
...
public class GenericDAO<T> implements DAO<T> {
	 ...
	 */
	public GenericDAO(Class genericDAOClass) {
	...
	public void create(T arg0) {
		Transaction tx = null;
		Session s = sessFact.getCurrentSession();
		try {
